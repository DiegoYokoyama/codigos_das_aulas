...
print('                                     Bem Vindo                                  ') #coloquei um print com Boa Tarde
print('================================================================================')#coloquei um print com (=) so pra ficar bonito
...
print('*Você pode ver o resultado aqui em baixo !')#coloquei esse printe para informar que o resultado vai sair em baixo dessa mensagem
